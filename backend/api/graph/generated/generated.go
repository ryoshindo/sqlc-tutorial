...
type MutationResolver interface {
	Signin(ctx context.Context, input model.SigninInput) (bool, error)
}
...
func (ec *executionContext) field_Mutation_signin_args(ctx context.Context, rawArgs map[string]interface{}) (map[string]interface{}, error) {
	...
	if tmp, ok := rawArgs["input"]; ok {
		...
		arg0, err = ec.unmarshalNSigninInput2githubᚗcomᚋryoshindoᚋsqlcᚑtutorialᚋbackendᚋapiᚋgraphᚋmodelᚐSigninInput(ctx, tmp)
		if err != nil {
			return nil, err
		}
	}
...
func (ec *executionContext) _Query_viewer(ctx context.Context, field graphql.CollectedField) (ret graphql.Marshaler) {
	...
	fc.Result = res
	return ec.marshalNAccount2ᚖgithubᚗcomᚋryoshindoᚋsqlcᚑtutorialᚋbackendᚋapiᚋgraphᚋmodelᚐAccount(ctx, field.Selections, res)
}
...
func (ec *executionContext) marshalNAccount2githubᚗcomᚋryoshindoᚋsqlcᚑtutorialᚋbackendᚋapiᚋgraphᚋmodelᚐAccount(ctx context.Context, sel ast.SelectionSet, v model.Account) graphql.Marshaler {
	return ec._Account(ctx, sel, &v)
}

func (ec *executionContext) marshalNAccount2ᚖgithubᚗcomᚋryoshindoᚋsqlcᚑtutorialᚋbackendᚋapiᚋgraphᚋmodelᚐAccount(ctx context.Context, sel ast.SelectionSet, v *model.Account) graphql.Marshaler {
	if v == nil {
...
func (ec *executionContext) unmarshalNSigninInput2githubᚗcomᚋryoshindoᚋsqlcᚑtutorialᚋbackendᚋapiᚋgraphᚋmodelᚐSigninInput(ctx context.Context, v interface{}) (model.SigninInput, error) {
